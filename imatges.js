...
const imatges = [
    ...
    nom: "<br> Boku no hero Academia. <br> 僕のヒーローアカデミア。",
    ...
    nom: "<br> Kimetsu no Yaiba. <br> 鬼滅の刃。",
    ...
    nom: "<br> Shingeki no Kyôjin. <br> 進撃の巨人。",
